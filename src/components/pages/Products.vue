      ...
      <tbody>
        <tr v-for="(item) in products" :key="item.id">
          ...
          <td>
            ...
            <button class="btn btn-outline-danger btn-sm" @click="deleteModalShow(item)">刪除</button>
          </td>
        </tr>
      </tbody>
    </table>
<Pagination :allPages='pagination' @update='getProducts'></Pagination>
<!-- Modal -->
...
<div class="modal fade" id="delProductModal" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content border-0">
      ...
      <div class="modal-body">
        是否刪除 {{tempProduct.title}}<strong class="text-danger"></strong> 商品(刪除後將無法恢復)。
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">取消</button>
...
export default {
  ...
  methods: {
    ...
    deleteProduct () {
      const vm = this
      const api = `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOM_PATH}/admin/product/${vm.tempProduct.id}`
